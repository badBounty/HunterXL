...
OUTPATH_SUBDOMAINS_HTTPX="outputs/httpx.csv"
...
print("--------------Init httpx")
os.system("httpx -silent -csv -l "+ OUTPATH_SUBDOMAINS_WEBAPP+" -o "+OUTPATH_SUBDOMAINS_HTTPX+" -screenshot")

os.system("mv output ./outputs/httpx")
